...
export default function Home() {
  ...
  return (
    <div
      className={`${
        dark
          ? "h-screen  bg-gray-900 w-screen "
          : "h-screen  bg-gray-200 w-screen "
      } `}
    >
      <Head>
        ...
        <meta
          name="description"
          content="Track the transaction fees of Ethereum using our simple and blazing fast gas tracker!"
        />
      ...
      <div className="flex px-7 md:px-20 pt-12 md:pt-12 justify-end h-fit">
        <button className="hover:cursor-pointer pr-6">
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/aleemrehmtulla/simplegwei"
          >
            <BsGithub
              size={40}
      ...
      <div className="pt-20 md:pt-24">
        <div className=" text-center">
          ...
          <p
            className={`${
              dark ? "text-gray-300" : "text-black"
            } font-semibold  text-xl md:text-3xl pt-2 `}
          >
            ETH Price ${price} USD
          </p>
        </div>
        ...
        <div className="grid place-content-center mt-8 mr-3 ml-3 ">
          <div
            ...
            } text-center border-solid px-9 py-8 md:px-32 md:py-18 rounded-3xl border-[6px]  w-fit  `}
          >
            <div className="flex justify-center">
              <h1
                className={`${
                  dark ? "text-gray-300" : "text-black"
                } text-8xl md:font-bold font-semibold`}
              >
                {gas}
              </h1>
              <h1 className="text-7xl pt-3 pl-1">⛽️</h1>
            </div>
            <p
              className={`${
                dark ? "text-gray-300" : "text-black"
              } text-2xl pt-1 w-full font-medium `}
            >
              This is {level}
            </p>
            <p className={`${dark ? "text-gray-300" : "text-black"} w-60 pt-1`}>
              Last updated {secondsSince} seconds ago
            </p>
          </div>
        </div>
      </div>
